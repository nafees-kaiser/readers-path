...
const AllBooksRelatedLayout = ({children}) => {
    ...
    // useEffect(() => console.log(filterData))
    ...
    return (
        <section className={"min-h-screen relative"}>
            ...
            <div className={"flex gap-10 mt-8"}>
                ...
                {isCategoryModalOpen && (
                    <div className={"md:hidden absolute -top-4 w-full h-full bg-gray-400/40"}>
                        <div
                            className={"md:hidden " +
                                " w-1/2 py-4 px-4" +
                                " sm:px-10 bg-white " +
                                "absolute h-full " +
                                "shadow-gray-700/40 shadow-lg"}>
                            <CategoryFilter
                ...
                <div
                    className={"flex flex-col items-center justify-start gap-3 bg-secondary-bg min-h-full w-full px-[15px] pt-4 pb-10 rounded-t-xl md:rounded-tr-none md:pl-6 lg:pl-8 md:pr-[50px] lg:pr-[100px]"}>
