...
export default function Option({menuItems, title}) {
    const className = 'shadow-sm ring-1 ring-inset ring-gray-300  hover:bg-gray-50'
    return (
        <Menu as="div" className="relative inline-block text-left">
            <div>
                <MenuButton
                    className="text-xs md:text-base bg-transparent inline-flex w-full justify-center gap-x-1.5 rounded-md bg-white px-3 py-2 font-semibold">
                    {title}
